...
const HELP_ITEMS: { title: string; body: string }[] = [
  {
    title: '开戏',
    body: '首页右上角「＋」：填标题即可开戏（默认发布到「讨论区」标签，可展开「高级设置」改标签、加内容、选角色或插图）。内容自动云端保存，换设备也能续写；发布后草稿自动清除。',
  },
  {
    title: '接戏',
    body: '在主题里点「接戏」续写楼层：默认只需写内容，**展开「高级设置」可**选角色、插图或 BBCode 格式。Ctrl + Enter 快捷提交，**提交后立即显示**，中途退出自动保存草稿。点击某条回复的「接戏」可 @指定楼层。',
  },
  {
    title: '角色卡',
    body: '头像菜单「角色卡」创建演绎角色（姓名+性别必填，年龄/身份/备注/外貌在「更多资料」里）。开戏/接戏/滴滴时可选择"以角色身份"，帖子与通知会显示角色的名字与头像。',
  },
  {
    title: '滴滴',
    body: '在帖子下点「滴滴」一键创建仅你与对方可见的私密主题，对方可在里面**接受 / 婉拒**。点作者名可看对方的接戏率与婉拒数。头像菜单「我的滴滴」查看私密主题列表与响应情况。',
  },
  {
    title: '邀请接戏',
    body: '主题作者点「🎭 邀请接戏」点名邀请戏友：一次最多 8 人，同标签优先，可搜索用户名；被邀请者会收到通知。每主题累计最多邀请 20 人。',
  },
  {
    title: '浏览与排序',
  ...
  {
    title: '格币与三连',
    body: '**每日打开自动 +10 格币**；今日任务另有奖励（首次开戏 +5、接戏 +3、滴滴 +3、点赞/收藏/投币/打赏各有）。**一键三连**（🎉）= 点赞+投币+收藏一步完成。投币/打赏作者实得 90%。累计格币提升等级（Lv.2 起作者名旁显示）。',
  },
  {
    title: '徽章与邀请',
  ...
  {
    title: '作者名片与屏蔽',
    body: '点作者名或徽章看名片：角色/皮下信息、徽章、被滴滴的接戏率与婉拒数；名片里可直接**屏蔽该用户**（头像菜单「屏蔽管理」可取消）。',
  },
  {
    title: '收藏夹',
  ...
  {
    title: '通知',
    body: '顶部铃铛看未读通知（接戏、滴滴、回复、设备授权等），点开自动进入对应主题并定位。通知**以角色身份显示**（对方用角色触发时显示角色名与头像）。开启「系统通知」后浏览器也会推送。',
  },
  {
    title: '导出记录',
    body: '主题卡下「⬇ 导出」可保存为图片（多种样式）或文字记录，方便留档分享。',
  },
  {
    title: '账号安全',
    body: '支持指纹 / 面容 / PIN 通行密钥一键登录，也可设密码备用。**删除自己的主题或帖子需验证身份**（当前密码或通行密钥），防止误删/盗号删内容。',
  },
  {
    title: '标签与 API',
